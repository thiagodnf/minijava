class MyClassToken {
    ...
    public MyClassToken(int type, int line, int col) {
        this.type = type;
        this.line = line;
        this.col = col;
    }

    public MyClassToken(int type, double numVal, int line, int col) {
        this(type, line, col);
        this.numVal = numVal;
    }

    public MyClassToken(int type, String strVal, int line, int col) {
        this(type, line, col);
        this.strVal = strVal;
    }
    ...
    public String toString() {
        if(this.type < 19) {
            return MyClassToken.names[this.type] + 
                    "(" + this.line + "," + this.col + ")";
